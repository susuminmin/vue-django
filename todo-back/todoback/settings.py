...
SECRET_KEY = 'bahm)fzqe1nu9y@72liwsewl_rv7%b0ai*^hp637ni=-*xsg@p'
...
INSTALLED_APPS = [
    ...
    # Third-Party Apps (따로 설치한 library)
    'rest_framework',
    'corsheaders',
...
JWT_AUTH = {
    ...
    # 최상단에 import datetime 추가
    'JWT_EXPIRATION_DELTA': datetime.timedelta(days=7),
    # 28일 마다 토큰 갱신 (유효기간 연장시)
